...
#Opening json file
filepath = '/global/homes/v/vsharma2/Tri_proton_decay/High_multiplicity_events_study/GroupedEventsAndTimesM10Count10.json'
...
with open("EventTimesAndRunNumbers.txt",'w') as output:
    for event in object:
        ...
        output.write(str(timeDifference) + ',' + str(channel) + ',' + str(eventDatetime) + '\n')
